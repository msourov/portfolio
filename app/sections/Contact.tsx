  ...
  <section className="section-container sm:gap-8" id="contact">
    ...
    <div className="text-center max-w-[580px] mx-auto">
      <p>
        ...
        or want to connect, feel free to reach out anytime. You can message me through social media
        or by email. I’m happy to help and will get back to you as soon as possible.
      </p>
